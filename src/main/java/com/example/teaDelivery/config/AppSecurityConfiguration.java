...
import com.example.teaDelivery.service.AppUserDetailsService;
                ...
                .authorizeHttpRequests(
                        authorizeHttpRequests ->
                                authorizeHttpRequests.
                                        ...
                                        .requestMatchers("/", "/tea/", "/tea/{}", "/users/login", "/users/register", "/users/login-error")
                                        .permitAll().
                                        requestMatchers("/users/profile",
                                                "/basket/add-tea","/basket/remove-tea", "/basket/", "/basket/order",
                                                "/discounts/","/discounts/apply-discount","/discounts/add-discount")
                                        .authenticated().
                                        requestMatchers("/admin/order/", "/admin/order/{}")
